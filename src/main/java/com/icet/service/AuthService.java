...
public class AuthService {
    ...
    public UserResponseDTO register(UserRegistrationDTO dto) {
        ...
        // Resolve the role from the frontend value.
        // The frontend sends 1=ADMIN, 3=BUYER, 4=SELLER.
        ...
        // Create and save UserCredentials (password hashed) and link to user
    ...
    public UserResponseDTO login(UserLoginDTO dto) {
        ...
        // Resolve the user from credentials
